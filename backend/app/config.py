...
class Settings(BaseSettings):
    ...
    llm_api_url: str = Field(
        default="http://192.0.2.75:1234/v1/chat/completions", alias="LLM_API_URL"
    )
    ...
    stt_download_root: Path = Field(
        default=Path("E:/AI_Models/Voice/faster-whisper"), alias="STT_DOWNLOAD_ROOT"
    )
